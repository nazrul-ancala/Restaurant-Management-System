...
export const GET_TABLES = "/tables";
export const GET_MENU_ITEMS = "/menu/items";
export const UPLOAD_MENU_IMAGE = "/menu/upload";
...
export const GET_LOW_STOCK_REPORT = "/reports/inventory/low-stock";
export const GET_CONSUMPTION_REPORT = "/reports/inventory/consumption";
